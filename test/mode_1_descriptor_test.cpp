...
void test_carriers_equals_1536()
  {
  ASSERT_EQUAL(1536, dab::__internal_common::types::mode_1::carriers::value);
  }

void test_frame_symbols_equals_75()
  {
  ASSERT_EQUAL(75, dab::__internal_common::types::mode_1::frame_symbols::value);
  }

void test_fic_symbols_equals_3()
  {
  ASSERT_EQUAL(3, dab::__internal_common::types::mode_1::fic_symbols::value);
  }

void test_msc_symbols_equals_72()
  {
  ASSERT_EQUAL(72, dab::__internal_common::types::mode_1::msc_symbols::value);
  }

void test_frame_fibs_equals_12()
  {
  ASSERT_EQUAL(12, dab::__internal_common::types::mode_1::frame_fibs::value);
  }

void test_frame_cifs_equals_4()
  {
  ASSERT_EQUAL(4, dab::__internal_common::types::mode_1::frame_cifs::value);
  }

void test_fib_codeword_bits_equals_768()
  {
  ASSERT_EQUAL(768, dab::__internal_common::types::mode_1::fib_codeword_bits::value);
  }
